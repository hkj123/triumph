package com.accumulate.file.web.rest;
...
public class FileCridFsUploadResource {
    private final Logger log = LoggerFactory.getLogger(FileCridFsUploadResource.class);
    @Autowired
