...
public class UsernameUtil {
    ...
    public static boolean Username(final String v) {

        final Matcher m = pUsername.matcher(v);
        if (m.matches()) {
            return true;
        }
        return false;
    ...
    public static boolean Mobile(final String v) {

        final Matcher m = pMobile.matcher(v);
        if (m.matches()) {
            return true;
        }
        return false;
    ...
    public static boolean Email(final String v) {

        final Matcher m = pEmail.matcher(v);
        if (m.matches()) {
            return true;
        }
        return false;
